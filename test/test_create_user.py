...
pytestmark = [allure.parent_suite("reqres"), allure.suite("create_user")]
...
def test_single_user_valid_parameters(reqres_api, request_parameters):
    reqres_api.reqres_create(request_parameters).status_code_should_be(201).json_schema_should_be_valid(
        "create_user_schema"
